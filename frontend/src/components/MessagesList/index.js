            ...
            <React.Fragment key={message.id}>
              ...
              <div className={classes.messageLeft}>
                ...
                <div className={classes.textContentItem}>
                  ...
                  <MarkdownWrapper>{(message.mediaType === 'contactMessage' || message.mediaType === "locationMessage" || message.mediaType === 'contactsArrayMessage') ? ' ' : message.body}</MarkdownWrapper>
